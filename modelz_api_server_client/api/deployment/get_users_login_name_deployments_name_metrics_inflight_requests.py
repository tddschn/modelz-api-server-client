...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/users/{login_name}/deployments/{name}/metrics/inflight_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the deployment inflight requests metrics.

     Get the deployment inflight requests metrics with the given deployment name.
