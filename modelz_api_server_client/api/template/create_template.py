...
from ...models.github_com_tensorchord_modelz_apiserver_api_types_template_create_request import (
    GithubComTensorchordModelzApiserverApiTypesTemplateCreateRequest,
)
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: GithubComTensorchordModelzApiserverApiTypesTemplateCreateRequest,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = GithubComTensorchordModelzApiserverPkgQueryTemplate.from_dict(response.json())
