...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesVersionInfo")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesVersionInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_version_info = cls(
        ...
        github_com_tensorchord_modelz_apiserver_api_types_version_info.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_version_info
