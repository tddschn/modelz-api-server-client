...
if TYPE_CHECKING:
    ...
    from ..models.github_com_tensorchord_modelz_apiserver_api_types_template_update_request_env_vars import (
        GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequestEnvVars,
    )


T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequest")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequest:
    """
    Attributes:
        command (Union[Unset, str]):
        deployment_source (Union[Unset, GithubComTensorchordModelzApiserverApiTypesDeploymentSource]):
        description (Union[Unset, str]):
        env_vars (Union[Unset, GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequestEnvVars]):
    ...
    env_vars: Union[Unset, "GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequestEnvVars"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_env_vars, Unset):
            ...
            env_vars = GithubComTensorchordModelzApiserverApiTypesTemplateUpdateRequestEnvVars.from_dict(_env_vars)
        ...
        github_com_tensorchord_modelz_apiserver_api_types_template_update_request = cls(
            command=command,
        ...
        github_com_tensorchord_modelz_apiserver_api_types_template_update_request.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_template_update_request
