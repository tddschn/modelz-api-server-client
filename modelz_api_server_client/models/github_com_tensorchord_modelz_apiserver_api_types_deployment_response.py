...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesDeploymentResponse")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesDeploymentResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_deployment_response = cls(
            spec=spec,
            status=status,
        )

        github_com_tensorchord_modelz_apiserver_api_types_deployment_response.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_deployment_response
