...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesDeploymentGitSource")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesDeploymentGitSource:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_deployment_git_source = cls(
            branch=branch,
            builder=builder,
            directory=directory,
            image=image,
        ...
        github_com_tensorchord_modelz_apiserver_api_types_deployment_git_source.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_deployment_git_source
