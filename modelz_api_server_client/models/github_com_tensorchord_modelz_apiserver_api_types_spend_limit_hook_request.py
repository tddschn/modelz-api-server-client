...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesSpendLimitHookRequest")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesSpendLimitHookRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_spend_limit_hook_request = cls(
        ...
        github_com_tensorchord_modelz_apiserver_api_types_spend_limit_hook_request.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_spend_limit_hook_request
