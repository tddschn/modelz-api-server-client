...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesBuildListResponse")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesBuildListResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_build_list_response = cls(
            deployment=deployment,
        )

        github_com_tensorchord_modelz_apiserver_api_types_build_list_response.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_build_list_response
