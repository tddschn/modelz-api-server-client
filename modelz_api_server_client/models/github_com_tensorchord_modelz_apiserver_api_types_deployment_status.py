...
T = TypeVar("T", bound="GithubComTensorchordModelzApiserverApiTypesDeploymentStatus")


@attr.s(auto_attribs=True)
class GithubComTensorchordModelzApiserverApiTypesDeploymentStatus:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        github_com_tensorchord_modelz_apiserver_api_types_deployment_status = cls(
        ...
        github_com_tensorchord_modelz_apiserver_api_types_deployment_status.additional_properties = d
        return github_com_tensorchord_modelz_apiserver_api_types_deployment_status
